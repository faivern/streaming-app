...
- [x] **INFRA-01**: Embedding pipeline seeds 10,000 TMDB titles into pgvector with text-embedding-3-small embeddings
...
- [x] **INFRA-04**: Embedding pipeline runs as background service with checkpoint/restart support
