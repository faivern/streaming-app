...
import { useListById, useUserLists } from "../../hooks/lists/useLists";
import {
  HeroStatCard,
  GenreDonutCard,
  TopGenresCard,
    ...
    <>
      <nav aria-label="Breadcrumb" className="mb-6">
        <ol className="flex items-center gap-2 text-sm">
          ...
          <li className="text-subtle">/</li>
          <li className="text-text-h1" aria-current="page">Insights</li>
        </ol>
      </nav>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-text-h1">
          {list?.name ?? "Insights"}
        </h1>
      </div>

      <ListSnapshotStrip lists={lists} activeListId={listId} />
    </>
  );
