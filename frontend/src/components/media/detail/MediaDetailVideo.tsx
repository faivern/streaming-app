...
export default function MediaDetailVideo({
  ...
  return (
    <div className="relative m-4 overflow-hidden rounded-lg shadow-2xl group max-w-6xl mx-auto border border-badge-foreground">
      ...
      {!isPlaying && (
        <>
          ...
          <div className="absolute inset-0 flex items-center justify-center z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer">
            <div
              className="bg-gray-100 bg-opacity-80 hover:bg-opacity-100 text-black p-4 rounded-full shadow-lg transition-transform duration-300 group-hover:scale-110 animate-pulse"
              role="button"
